...
public class CustomDaoJdbcImpl implements CustomDao {
	...
	public int UpdateOne(int id, int select_id, String memory, String hardDisc, String cpu, int customPrice) {
		...
		int result = jdbc.update(
				"update custom set memory = ? ,hard_disc = ? ,cpu = ? ,custom_price = ? where product_id = ? and user_id = ? and purchase_check is null",
				memory, hardDisc, cpu, customPrice, id, select_id);
	...
	public PcDetailDataDTO selectOne(int id, int select_id) {
		...
		Map<String, Object> map = jdbc.queryForMap(
				"select * from custom where product_id = ? and user_id = ? and purchase_check is null", id, select_id);
	...
	public CustomDTO selectCustomProduct_id(int id, int select_id) {
		...
		try {
			Map<String, Object> map = jdbc.queryForMap(
					"select * from custom where product_id = ? and user_id = ? and purchase_check is null", id,
					select_id);
	...
	public int insertCustomData(int id, int select_id, String defaultMemory, String defaultHardDisc, String defaultCpu,
		...
		int result = jdbc.update(
				"insert into custom (product_id," + " user_id," + " memory," + " hard_disc," + " cpu,"
						+ " custom_price)" + " value(?,?,?,?,?,?)",
				id, select_id, defaultMemory, defaultHardDisc, defaultCpu, customPrice);
	...
	public int deleteCustomOne(int id, int getId) {
		...
		int result = jdbc.update("delete from custom where product_id = ? and user_id = ? and purchase_check is null",
				id, getId);
		return result;
	}
	...
	public int purchaseCheckUpdate(int select_id, int product_id) {
		int result = jdbc.update("update custom set purchase_check = ? where user_id = ? and product_id = ?",
				product_id, select_id, product_id);
		return result;
	}
	...
	public int purchaseIdUpdate(int purchaseId, int productId, int userId) {
		int result = jdbc.update(
				"update custom set purchase_check = ? where product_id = ? and user_id = ? and purchase_check is null",
				purchaseId, productId, userId);
